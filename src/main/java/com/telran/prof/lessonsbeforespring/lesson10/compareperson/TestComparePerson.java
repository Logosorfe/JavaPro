package com.telran.prof.lessonsbeforespring.lesson10.compareperson;
...
public class TestComparePerson {
    ...
    public static void main(String[] args) {
        ...
        //Странно, но тут не переопределены методы hashcode и equals и получается сет будет сравнивать уникальность
        // по адресам
    }
}
